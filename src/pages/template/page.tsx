...
export default function TemplatePage() {
  ...
  <div className="bg-[#EDF1F5] min-h-screen w-full">
    ...
    <button className="bg-[#ED6F2A] text-[#FFFFFF] px-4 py-1.5 rounded-sm flex items-center gap-2 cursor-pointer hover:bg-[#ed6e2aee] active:bg-[#BA6F47] transition delay-60 duration-40 ease-in-out"><MagnifyingGlass size={20} weight="bold" /> Pesquisar</button>
        <button onClick={() => modalRef.current?.openModal()}  className="bg-[#46B7BA] text-[#FFFFFF] px-4 py-1.5 rounded-sm flex items-center gap-0.5 cursor-pointer hover:bg-[#46b6baf3] active:bg-[#1096DE] transition delay-60 duration-40 ease-in-out"><Plus size={20} weight="bold"/>Novo Template</button>
        </div>
        ...
        modalElement={ <form className="flex flex-col gap-3">
