...
export default function CronGenerator({
  ...
  const handleDayChange = (day: number) => {
    ...
    if (startDate) {
      ...
      cronDayOfMonth = (date.getDate() + 1).toString();
  ...
  return (
    <form className="flex flex-col gap-2" onSubmit={handleSubmit}>
      <div className="flex flex-col gap-1 mt-[5px]">
        ...
        ></Input>
        <label className="mt-1 text-[#929292] text-[13px]">
        ...
        {repeatType === "diariamente" && (
          <div className="mt-4 ">
            ...
            <select
              ...
              onChange={(e) => setRepeatCondition(Number(e.target.value))}
            >
        ...
        <div className="flex justify-end space-x-3">
          ...
          <Button variant="teal-solid">Salvar</Button>
        </div>
      </div>
    </form>
  );
