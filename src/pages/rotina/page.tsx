...
export default function RotinaPage() {
  return (
    <div className="font-[Poppins] bg-gray-100 min-h-screen">
      ...
      <div className="flex items-end gap-6 border border-gray-300 py-6 pl-4 w-full">
        ...
        <button className="bg-orange-500 text-white px-4 py-2 rounded-sm flex items-center gap-2 cursor-pointer">
          <MagnifyingGlass size={20} weight="bold" /> Pesquisar
        </button>
        <button className="bg-[#46B7BA] text-white px-4 py-2 rounded-sm flex items-center gap-2 cursor-pointer">
